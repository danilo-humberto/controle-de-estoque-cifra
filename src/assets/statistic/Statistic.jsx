  ...
  return (
    <div className='container-statistic'>
      ...
      <div className='container-statistic-content'>
        <div>
            <Users size={50} style={{color: "var(--sky-700)"}}/>
            <p>Funcionários</p>
            <span>1</span>
            <span className='shadow-blue'></span>
        </div>
        <div>
            <Voicemail size={50} style={{color: "var(--pink-700)"}}/>
            <p>Linhas</p>
            <span>1</span>
            <span className='shadow-pink'></span>
        </div>
        <div>
            <Smartphone size={50} style={{color: "var(--emerald-700)"}}/>
            <p>Celulares</p>
            <span>1</span>
            <span className='shadow-emerald'></span>
        </div>
        <div>
            <Laptop size={50} style={{color: "var(--purple-700)"}}/>
            <p>Notebooks</p>
            <span>1</span>
